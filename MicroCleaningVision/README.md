...
- 近场执行：**每天先看** [当前该做什么与项目日志](说明文档/总流程说明/当前该做什么与项目日志.md)。准则仍是 [作战总表](说明文档/总流程说明/项目作战总表.md)。同学机已报 F103 短喷，本仓无该次证据、不冻结本机 Demo。下一阶段先把 U500 数据集做大，再训练分割；路径先预览，有行程再谈 XY。
- 像素到毫米标定：尚未验证。
